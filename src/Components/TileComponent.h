...
class TileComponent: public Component {
	public:
		...
		TileComponent(int soureRectX, int soureRectY, int x, int y, int tileSize, int tileScale, std::string assetTextureId) {
			texture = Game::assetManager->GetTexture(assetTextureId);

			sourceRectangle.x = soureRectX;
			sourceRectangle.y = soureRectY;
